...
app.post('/loginSubmit', cors({credentials: true,origin: 'https://fcard.luishsu.me'}), (req, res) => {
    let bufferStr = "";
    req.on('data', data => {
...
app.post('/registerSubmit',cors({credentials: true,origin: 'https://fcard.luishsu.me'}), (req, res) => {
    let bufferStr = "";
...
app.get('/drawSubmit',cors({credentials: true,origin: 'https://fcard.luishsu.me'}), (req, res) => {
  if(!req.session.acc){
...
app.get('/getDrewData',cors({credentials: true,origin: 'https://fcard.luishsu.me'}), (req, res) => {
  if(!req.session.acc){
    res.end('You have to login first') 
  }else{
    sql.ifdrew(req.session.acc)
...
app.get('/logout', cors({credentials: true,origin: 'https://fcard.luishsu.me'}), (req, res) => {
  req.session.destroy();
  console.log("logout")
  res.end('logoutOK');
});
